        ...
        <div class="row mb-5">
            <div class="col-md pt-5">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <p>Website Vitour cho phép đặt các tour du lịch trong vào ngoài nước.</p>
            ...
            <div class="col-md pt-5 border-left">
                <div class="ftco-footer-widget pt-md-5 mb-4">
                    ...
                    <div class="block-23 mb-3">
                        <ul>
                            <li><span class="icon fa fa-map-marker"></span><span class="text"> 123 Nhổn, Cầu Giấy, Hà Nội</span></li>
                            <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">0123456789</span></a></li>
                            <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">thangvip@gmail.com</span></a></li>
                        </ul>
                    </div>
                </div>
            </div>
